  ...
  methods: {
    ...
    viewPurchaseProduct: function viewPurchaseProduct() {
      ...
      axios.get("purchaseProductGet").then(function (res) {
        _this5.purchaseproducts = res.data.productgt;
      })["catch"](function (err) {
        return console.log(err);
      });
    },
                                ...
                                _c(
                                  ...
                                  [
                                    ...
                                    _c(
                                      ...
                                      {
                                        attrs: {
                                          id: "modal" + product.productNameId,
                                          size: "xl",
    ...
    _c("div", [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "col-12 col-md-12 cartml overflow-auto" }, [
                ...
                _vm._l(_vm.carts, function(cart, index) {
                  return _c("tr", { key: cart.id }, [
                    ...
                    _c("td", { staticClass: "p-0" }, [
                      _c("p", { staticClass: "cartpname" }, [
                        _vm._v(_vm._s(cart.pname))
                      ])
                    ]),
                    _vm._v(" "),
                    _c("td", { staticClass: "p-0" }, [
