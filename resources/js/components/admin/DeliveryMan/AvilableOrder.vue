<template>
  <div class="row" data-toggle="isotope">
    ...
    >
      ...
      <div v-for="dtime in dtimes" :key="dtime.id">
 <h1 style="text-align: center;" >
       {{dtime.deliveryTime}}
      </h1>
      <div v-for="order in orders" :key="order.id" v-if="order.deliveryTime==dtime.deliveryTime">
...
export default {
  ...
  methods: {
    ...
    accepted(id) {
      axios.get(`deliveryMan/${id}`).then((res) => {
        Toast.fire({
          icon: "success",
