              ...
              <div class="selector">
                <select id="inputState" class="form-control">
                  ...
                  <option
                    ...
                    @click.prevent="delivered(order.invoiceNo)"
                  >
               Delivered
                  </option>
...
export default {
  ...
  methods: {
    ...
    delivered(id) {
      axios.get(`deliveryMan/${id}/edit`).then((res) => {
        Toast.fire({
          icon: "success",
    ...
    seenCount() {
      axios
        ...
        .then((res) => {
          res.data.onOrder.forEach((order) => {
    ...
    messageRead(id) {
      axios.get(`deliveryManMessageRead/${id}`).then((res) => {
