...
<div >
        <center><h3 class="align-center cush"><i class="far fa-user"></i>&nbsp; Registration</h3></center>
       <form @submit.prevent="add">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              >
                <label for="exampleFormControlInput1"> User Name<span style="color:red">*</span></label>
                <input
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              >             
                <label class="col-sm-4  ml-0">Date of Birth<span style="color:red">*</span></label>
                <div class="col-sm-8">
           ...
           <p  v-if="infos.name" style="display:none">You Have Sponsor?  <span v-if="click"><button class="badge badge-primary"   @click.prevent="clickHere(ok)">Click Here</button></span><span v-if="need"><button class="badge badge-danger"  @click.prevent="needFun(ok)">No need</button></span></p> 
           <p  v-else>You Have Sponsor?  <span v-if="click"><button class="badge badge-primary"   @click.prevent="clickHere(ok)">Click Here</button></span><span v-if="need"><button class="badge badge-danger"  @click.prevent="needFun(ok)">No need</button></span></p> 
